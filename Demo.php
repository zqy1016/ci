...
class Demo
{
	private static $appKey = "23449549";
    private static $appSecret = "995ef6a643d6ceb7d48c20ed29602113";
	//协议(http或https)://域名:端口，注意必须有http://或https://
    private static $host = "http://9fb5f9308d394384bcc1958d51cee9f6-cn-hangzhou.alicloudapi.com";
	/**
	*method=GET请求示例
	*/
    public function doGet($city="null") {
		//域名后、query前的部分
		$path = "/weather/query";
	...
	//	$request->setHeader("a-header1", "headervalue1");
		...
		$request->setQuery("city", "$city");
//		$request->setQuery("citycode", "101210101");
//		$request->setQuery("cityid", "382");
